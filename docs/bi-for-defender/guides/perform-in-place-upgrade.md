...
![defender select app](../images/defender_select_app-1024x659.png)
...
1. Select **Get It Now**.
![defender get it now](../images/defender_get_it_now-1024x662.png)
...
1. Select **Get it Now**.
![defender confirmation](../images/defender_confirmation.png)
