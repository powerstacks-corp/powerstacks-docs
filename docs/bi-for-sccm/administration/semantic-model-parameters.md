...
1. Expand **Parameters**.
1. Enter the **API Key** that you received from us after completing the [Request a Trial Key](../installation/getting-started/request-a-license.md) form.
...
### Step 4: Expand Gateway Connection
...
### Step 6: Return to the Workspace
...
### Step 8: Add Gateway Data Source
