...
1. You will see a notification that BI for SCCM is installing. Once this has disappeared you have successfully installed BI for SCCM. You may now view the app using the sample data provided or you can connect your data by [requesting a trial license key](../../../shared/request-a-license.md).
...
1. Upon opening the BI for SCCM workspace you may notice a banner that says, "**You're viewing this app with sample data. Connect your data**." This can be safely ignored. If you'd like to try BI for SCCM before connecting your data it installs with sample data. If you prefer to go ahead and see your own data proceed to the next step in our documentation.
