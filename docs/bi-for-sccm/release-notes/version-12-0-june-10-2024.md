...
- **Features:**Added new "Device USB" category to the data model. This requires "[USB Device - Asset Intelligence (Win32_USBDevice)](../installation/custom-inventory/usb-devices.md)" to be added to hardware inventory.
**Enhancements:**
