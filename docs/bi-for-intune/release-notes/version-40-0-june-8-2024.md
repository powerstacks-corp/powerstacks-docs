...
BI for Intune Version 40.0, shown as version 1035 in AppSource, was released on June 8, 2024. This version includes some modifications to our Windows Enhanced Inventory script. Customers should update to the latest version of the [Enhanced Inventory script](../installation/custom-inventory.md).


## Below Are the Changes in Version 40.0


- **Features:**Windows Enhanced Inventory script changes:Collect friendly model name from Lenovo computers.
