...
Before Power BI can read data from the Log Analytics workspace, you must add the **Log Analytics API** permissions to your **Power BI app registration** (the one created during the [BI for Intune installation](../setup-guide/create-entra-app-registration.md)).
