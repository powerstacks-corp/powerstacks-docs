...
1. On the **Data pane** search for the new field name. You can find the new name in the "[What's New](https://docs.powerstacks.com/bi-for-intune/release-notes/)" section of our website. Select the field by placing a checkmark in the box beside the field name.
