...
### Step 2: Select the target workspace
...
### Step 5: Select Log Analytics Reader role
...
### Step 6: Assign the app registration
...
### Step 7: Review and assign the role
...
### Step 8: Record workspace ID and key
